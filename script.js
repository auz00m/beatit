...
function sendFeedback() {
  ...
  fetch("https://formspree.io/f/mldnzqqd", {
    method: "POST",
    ...
    .then(res => {
      if (res.ok) {
        status.innerText = "Thanks! Your feedback was sent.";
      } else {
        status.innerText = "Something went wrong. Try again.";
      }
    })
    .catch(() => {
      status.innerText = "Network error. Try later.";
    });
}
=======
/*********************/
...
>>>>>>> 74247f9d8c3331f35ec1ed589832b768e7c0783b
